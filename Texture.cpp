...
// You need an integer value to store the texture index that OpenGL returns when you load a texture
...
bool LoadTexture(char * filename, GLuint texid)
{
	...
	{ 
		...
		glBindTexture(GL_TEXTURE_2D, teximg.texID);
